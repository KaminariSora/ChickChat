...
<body>
    <div class="message-container">
        ...
        <div class="message-box">
            ...
            <div class="message">hello</div>
            <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo aperiam numquam
                aspernatur, ex, quas minima ratione soluta voluptates, provident omnis nisi quo. Saepe non porro
                suscipit voluptate autem voluptatibus ipsa.</div>
            <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo aperiam numquam
                aspernatur, ex, quas minima ratione soluta voluptates, provident omnis nisi quo. Saepe non porro
                suscipit voluptate autem voluptatibus ipsa.</div>
            <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo aperiam numquam
        ...
        <div class="container-HowToUse">
            <div class="slider-wrapper">
                ...
                <div class="image-list">
                    ...
                    <div>
                        <img src="../ImageAsset/ScreenShot/Screenshot 2023-12-11 105553.png" alt="img-1"
                            class="image-item">
                        <h1 class="subtitle">Avatar shop</h1>
                        <p class="description">user สามารถตกแต่ง <u>avatar</u>
                            ได้ตามความชอบโดยสามารถซื้อไอเท็มตกแต่งได้ที่ <u>Avatar shop</u> โดยจะใช้น่องไก่ในการซื้อ</p>
                    </div>
                    <div>
                        <img src="../ImageAsset/ScreenShot/Screenshot 2023-12-11 105840.png" alt="img-1"
                            class="image-item">
                        <h1 class="subtitle">Chick shop</h1>
                        <p class="description" style="text-align: center;">user สามารถซื้อ<u>น่องไก่</u>ได้ที่ <u>Chick
                                shop</u></p>
                    </div>
                </div>
